...
- (void)setup
{
    ...
    //做适配，BC添加代码--------------
    float  CATDayLabelWidth = 40.0f;
    if([JudgeMent judgeMent] == 0){
        CATDayLabelWidth = 53.50f;
    }
    else if([JudgeMent judgeMent] == 1){
        CATDayLabelWidth = 47.50f;
    }
    //------------------------------
    
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/2 - 150, 10.0f, 300.0f, 30.f)];
